...
7  CCI ICCCCCCCCCCCCCC CCICC O
6  cCi iCccCcCcCcCcC CcCiiiCcO
5  CC  CCCCCCCCCCCCC CCCCICCCO
4  cC  cCccCcC   CcCcCcCc - oO
3  CCCCCCCCCCC   CCCCCCCC - OO
2    _   c   _   Cc  _cCc_- oO
1     -     ---      -    -
...
| Silicon | D | GATE_N | RESET_B | VSS | Q | VDD |
| --- | --- | --- | --- | --- | --- | --- |
| NMOS1 |   |   |   | X |   |   |
| NMOS2 |   |   |   | X | X |   |
| PMOS1 |   |   |   | X | X | X |
