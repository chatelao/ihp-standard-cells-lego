...
8  cC +cCcc c c c c cCcCc cCoO
7  C I I      CCCCCCCC C I C O
6  c i i ci cCcCcCc  CcCiI CcO
5  CC       CCCCCCC  C C I   O
4  cC   Ccc cC   CcCcCcC  _ oO
...
| Silicon | VDD | VSS | VSS2 | VSS3 | VSS4 | VSS5 | D | GATE_N | RESET_B | Q |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| NMOS1 |   | X |   |   |   |   |   |   |   |   |
| NMOS2 |   | X | X |   |   |   |   |   |   | X |
| PMOS1 | X |   | X |   | X | X |   |   |   | X |
