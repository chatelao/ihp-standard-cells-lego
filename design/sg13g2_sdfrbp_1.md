...
7  C  xCI x I C   C    CC C    C  C C  C  C     C C C C    CO   C   O
6  Cx ICx I x CC CCCCC CC      CC C CC C CC   CCC CCC    C CO   CC OO
5  C   Cx   I    CC    CCCCCCCCCCCCCCC C  C   C  CCCCCCCCC Cxxx C   x
4  C x Cx     CCCCC    C  C   C      C    CCCCC CCCCCC     Cxxx C x x
