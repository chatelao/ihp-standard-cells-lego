...
3    +      ++       ++   +     +
2    &   c  &+cCcCc  +&   &     &
1  CC+ CCCC     C C  ++ C + O C + O
0  cC  cCc   Cc c c     c & o c & o
9  CCCCCCCCCCC  C C CCCCC + O C + O
8  c c    c cCcCc c    CcCc oOc & o
7  C I I  C CCCCCCCCC     C  OC   O
6  c i i  iCc cCcCcCcCc iIcCoOcCcCo
5  C      CCCCCCCCCC         OC   O
4  cC_-cC cCcCcCcCcC_ c   _Oo c _ o
3    -- C C -   CCCC- C   -OO C - O
2    _-     _     c _ c   _Oo   _ o
1    --     -       -     -     -
...
| Silicon | VDD | VSS | D | GATE_N | Input1 | RESET_B | Internal1 | Internal2 | Internal3 | Internal4 | Q | Q_N |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| NMOS1 |   | X |   |   |   |   |   |   |   |   |   |   |
| NMOS2 |   | X | X |   |   |   | X | X | X |   | X | X |
| PMOS1 | X |   | X |   |   |   |   |   | X | X | X | X |
