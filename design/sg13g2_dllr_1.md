...
8  c c    c cCcCc      CcCc oOc & o
7  C I I  C CC CCCCCC        OC   O
6  c i i  iCc  CcCcCcCc iIcCoOcCcCo
5  C      CCCCCC CCC         OC   O
4  c _-cC cCcCcCcCcC_ c   _Oo c _ o
3    -- C C -   CCCC- C   -OO C - O
2    _-     _     c _     _Oo   _ o
1    --     -       -     -     -
...
| Silicon | VDD | VSS | VSS2 | VSS3 | VSS4 | VSS5 | VSS7 | VSS8 | D | GATE_N | RESET_B | Q | Q_N |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| NMOS1 |   | X |   |   |   |   |   |   |   |   |   |   |   |
| NMOS2 |   | X | X | X | X | X |   |   |   |   |   | X | X |
| PMOS1 | X |   | X |   |   | X | X | X |   |   |   | X | X |
