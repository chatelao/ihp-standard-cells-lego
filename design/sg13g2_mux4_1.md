...
4  cCcCcCcc cCcCcCcCcCcCcCc cCcCcCcc Oo
3  CC   CCC C      CCC  CCCCCCCCCCC  OO
2  cCc  CccCc  c   CcC ccCcCcCcC   c
1
...
| Silicon | A0 | A1 | A2 | A3 | S1 | VDD2 | X | VDD | VSS | VSS10 | VSS11 | VSS12 | VSS13 | VSS14 | VSS15 | VSS16 | VSS17 | VSS18 | VSS19 | VSS2 | VSS20 | VSS21 | VSS22 | VSS23 | VSS3 | VSS4 | VSS5 | VSS6 | VSS7 | VSS8 | VSS9 |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| NMOS1 |   |   |   |   |   |   |   |   | X | X | X | X | X | X | X | X | X | X |   | X |   |   |   |   | X | X | X | X | X | X | X |
| NMOS2 |   |   |   |   |   | X | X |   |   |   |   |   |   |   |   |   |   |   | X |   | X | X | X | X |   |   |   |   |   |   |   |
| PMOS1 |   | X | X |   |   | X | X | X |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |
| PMOS2 |   |   |   |   |   |   |   | X |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |
| Poly1 | X |   |   |   |   |   |   | X |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |
