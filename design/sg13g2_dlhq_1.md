...
2  &     &c c cCcC   +      &
1  + C CCCC   C             + O
0  & c c cc cCc c c c c cCc & o
9  + C C  C  CC CCCCCCCCCCC + O
8    c      cCc cCcCc  CcC    o
7  IICC     CCC  C  C  CCCIICCO
6  iIcC Ccc c c cC  c cCcCiIcCo
5    CC     CCC     C  C CC COO
4    c c _ Cc     c c  Cc c cOo
3  - C C -  CCCCC   C    CCCCOO
2  _     _cCcCcCcCcCc     c
1  -     -           --    --
...
| Silicon | VDD | VSS | VSS2 | D | GATE | Internal1 | Internal2 | Internal3 | Internal5 | Internal6 | Q |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| NMOS1 |   | X |   |   |   |   |   |   |   |   |   |
| NMOS2 |   | X | X |   |   | X | X | X |   |   | X |
| PMOS1 | X |   | X |   |   | X |   |   | X | X | X |
