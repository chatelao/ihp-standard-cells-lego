...
0  c c c c    cCcC&+c c c   & iCiI +i cCiIcCcCc c c c c oOc & o
9        CC  C   C  CC      + IC IIII CC ICC  CCC       OOC   O
8   I I   c cC CcCc  C Cc cCc iCcCiCc c cIi  I  c  Cc c oOc   o
7   I I IiC  C C     C  C   C I     C C  IIIII  C  C     OCC  O
6  iI  iIic  CcCiI CcCcCc cCc i c c c c cCcCi cCc cCiIcC OcC  o
5   I  CCCCCCC CII   CCCC  CCCCCC     C CC CCCCCC  C     OC   O
4      c  _ cCcC    c c c cCcCcCcCcC -c cCc _ c c cCc _ oOc _ o
3  -      - C   CCCCCCC C            -C  C  - C   C   - OOC - O
...
| Silicon | VDD | VSS | VSS10 | VSS11 | VSS12 | VSS13 | VSS14 | VSS15 | VSS16 | VSS17 | VSS18 | VSS19 | VSS2 | VSS3 | VSS4 | VSS5 | VSS6 | VSS8 | CLK | D | RESET_B | SCD | Q | Q_N |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| NMOS1 |   | X |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |
| NMOS2 |   | X |   |   |   |   |   |   |   |   |   |   | X | X | X | X | X |   |   |   |   |   | X | X |
| PMOS1 | X |   | X | X | X | X | X | X | X | X | X | X | X |   | X | X | X | X |   |   | X |   | X | X |
| PMOS2 | X |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |
| Poly1 |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   | X |   |   |
| Poly10 |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   | X |   |   |   |
| Poly11 |   |   |   |   |   |   |   |   |   |   |   |   |   |   | X |   |   |   |   |   | X |   |   |   |
