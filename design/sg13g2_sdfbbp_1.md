...
| Silicon | VDD | VSS | CLK | D | RESET_B | SCD | SCE | SET_B | Internal1 | Internal10 | Internal11 | Internal12 | Internal13 | Internal14 | Internal15 | Internal16 | Internal2 | Internal3 | Internal4 | Internal5 | Internal7 | Internal9 | Q | Q_N |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| NMOS1 |   | X |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |
| NMOS2 |   | X |   |   |   |   |   |   | X |   |   |   |   |   |   |   | X | X | X | X |   |   | X | X |
| PMOS1 | X |   |   |   |   |   | X | X | X | X | X | X | X | X | X | X |   | X | X | X | X | X | X | X |
| PMOS2 | X |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |
| Poly1 |   |   |   |   |   | X |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |
| Poly10 |   |   |   |   |   |   |   | X |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |
| Poly11 |   |   |   |   |   |   |   | X |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |
