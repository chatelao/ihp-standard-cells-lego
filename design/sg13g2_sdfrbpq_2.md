...
1     +C      C+ CC  +       C +    C                     + OO+
0  c   c  cC  c+ Cc  +c cCc cCc c c c   cCcCcCcCcCc       & oO&
9  C     CCC  C+ CC  +C C   C     C     C       C  C    C   OO+
8  c   cCcc   c+ Cc   c c cCcCcCcCc   cCc cCcCcCc cCc cCcCcCoO&
7  C      I I C   C     C C II C  C    C   III  C   C C    C O
6  cIi cIii i cCcCcCcC  c   iIc c c cCcC CcIiIcCc cCc c  CcC Oo
5  C    I   I     C     C       C    C C   IIIC     CCCCCC C  O
4  c _ cIiiIi cCc c       c c c     cC    c c c c c        C_ o _
3  C - CCCCCCC -  C  CC - C -  CCCCCCC       CC CCCCCC -  CC- O -
...
| Silicon | VDD | VSS | VSS10 | VSS11 | VSS12 | VSS13 | VSS14 | VSS15 | VSS19 | VSS2 | VSS21 | VSS22 | VSS23 | VSS24 | VSS25 | VSS26 | VSS3 | VSS4 | VSS5 | VSS6 | VSS7 | VSS8 | VSS9 | CLK | RESET_B | SCD | SCE | Q |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| NMOS1 |   | X |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |
| NMOS2 |   | X | X | X | X | X | X |   |   | X |   |   |   |   |   |   | X | X | X | X | X | X | X |   |   | X |   | X |
| PMOS1 | X |   |   |   |   |   |   | X | X |   | X | X | X | X | X | X |   | X |   | X | X | X |   |   |   |   |   | X |
| PMOS2 | X |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |
| Poly1 |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   | X |   |
| Poly2 |   |   |   |   |   |   |   |   |   |   | X |   |   |   |   |   |   |   |   |   |   | X |   |   |   | X |   |   |
| Poly3 |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   | X |   |   |   |
