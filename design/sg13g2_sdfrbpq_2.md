...
1     +C      C+ CC ++       C +CCCCC                     ++OO+
0  c   c  cC  c+ Cc &+c cCc cCcCc c c   cCcCcCcCcCc       &+oO&
9  CCCCC CCC  C+ CC ++C C   C     C   CCC       C CC    CC  OO+
8  c   cCcc   c+ Cc   c c cCcCcCcCc   cCc cCcCcCc cCc cCcCcCoO&
7  CII    I I CC  C     C C II C  C    C CCIII  C C C C    C O
6  cIi cIii i cCcCcCcC  c   iIc c c cCcC CcIiIcCc cCc c  CcC Oo
5  C    I   I     C     CCCCCCC CCCC C C  CIIIC     CCCCCC C  O
4  c _ cIiiIi cCc c       c c c     cC    c cCc c c        C_ o _
3  C - CCCCCCCC-  C CCC - C - CCCCCCCC       CC CCCCCC -  CC- O -
...
| Silicon | VDD | VSS | CLK | D | RESET_B | SCE | Internal1 | Internal2 | Internal3 | Internal4 | Internal5 | Internal6 | Internal8 | Internal9 | Q |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| NMOS1 |   | X |   |   |   |   |   |   |   |   |   |   |   |   |   |
