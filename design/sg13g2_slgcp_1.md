...
2  &     &        &         &
1  +   C +        + CCCCC C +OO
0  &   cCccCcCcC    c c c c &Oo
9       C    CCC    CCC C C +OO
8  i iIiCccC CcCcCcCcCc c c  Oo
7  I  I C CCCCCC     C IC  C  O
6  i cCcCci cCcCcCc  CiIcC CcCo
5        C CC C      C     C  O
...
| Silicon | VDD | VSS | VSS2 | CLK | GATE | Input1 | SCE | Internal1 | Internal2 | GCLK |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| NMOS1 |   | X |   |   |   |   |   |   |   |   |
| NMOS2 |   | X | X |   |   |   |   | X |   | X |
| PMOS1 | X |   | X |   | X |   | X |   | X | X |
