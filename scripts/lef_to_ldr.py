...
def generate_ldr(macro_data):
    ...
    width_studs = width_ldu // 20
    active_width_studs = max(1, width_studs - 3)
    active_width_ldu = active_width_studs * 20
    active_x_start = ((width_studs - active_width_studs) // 2) * 20

    # NMOS strip: 3 studs high (60 LDU), Z=20 to 80
    nmos_z_start = 20
    nmos_height_ldu = 60
    ...
    # PMOS strip: 5 studs high (100 LDU), Z=height_ldu-120 to height_ldu-20
