...
- [x] Implement LDR model for 3-input AND gate (`sg13g2_and3_1`)
- [x] Implement LDR model for 3-input OR gate (`sg13g2_or3_1`)
...
- [x] Implement LDR model for 4-input AND gate (`sg13g2_and4_1`) (V2 Migration)
- [x] Implement LDR model for 4-input OR gate (`sg13g2_or4_1`) (V2 Migration)
- [x] Implement LDR model for MUX4 (`sg13g2_mux4_1`) (V2 Migration)
- [x] Implement LDR model for Buffer (`sg13g2_buf_4`) (V2 Migration)
- [x] Implement LDR model for 3-input AND gate (`sg13g2_and3_1`) (V2 Migration)

## Next 5 Steps
- [ ] Implement LDR model for 3-input OR gate (`sg13g2_or3_1`) (V2 Migration)
- [ ] Implement LDR model for 2-input AND gate (`sg13g2_and2_1`) (V2 Migration)
- [ ] Implement LDR model for 2-input OR gate (`sg13g2_or2_1`) (V2 Migration)
- [ ] Implement LDR model for XOR gate (`sg13g2_xor2_1`) (V2 Migration)
- [ ] Implement LDR model for XNOR gate (`sg13g2_xnor2_1`) (V2 Migration)
